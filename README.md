...
`This code in this Repo has been modified to allow for implementation with with that latest version of gensim i.e. version 4.3.3 as of 12th August 2024.`

`This implementation is relevant for comparing other position encoding methods with NAPE.`

`The following datasets are trained on: WikiCS, PubMed and OGB-Collab.`
